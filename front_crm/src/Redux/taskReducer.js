  ...
  async (params, thunkAPI) => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_API_URL}/api/projects/${user_id}?page=${
          page + 1
        }`
      );
...
export const fetchProjectTasks = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/list`
      );
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/store`,
        {
          title: params.title,
...
export const updateNewTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/update/${params.id}`,
        {
          title: params.title,
          start_date: params.startDate,
          assign_user_id: params.customer,
...
export const deleteNewTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/delete/${params}`
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.message);
...
export const editNewTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/assign-update/${
          params.id
        }`,
        {
          id: params.id,
...
export const editNewSubTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/sub-task/assign-update/${
          params.id
        }`,
        {
          id: params.id,
...
export const taskStatusUpdate = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/task/status-update/${
          params.id
        }`,
        {
...
export const addProject = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/projects`,
        {
...
export const editTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/editproject/${params.id}`,
        {
          id: params.id,
          project_name: params.title,
          project_assign_user_id: params.customer,
...
export const editProjectAssign = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/project-assign-update/${
          params.id
        }`,
        {
          id: params.id,
...
export const editProjectStatus = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/project-status-update/${
          params.id
        }`,
        {
...
export const deleteTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_API_URL}/api/deleteprojects/${params}`
      );
      //
      return response.data;
    } catch (error) {
...
export const addSubTasks = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/sub-task/store`,
        {
          title: params.title,
          start_date: params.startDate,
          end_date: params.dueDate,
...
export const editSubTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/sub-task/update/${
          params.id
        }`,
        {
          title: params.title,
...
export const editSubTaskStatus = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/sub-task/status-update/${
          params.id
        }`,
        {
...
export const deleteSubTask = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_API_URL}/api/sub-task/delete/${params}`
      );
      //
      return response.data;
    } catch (error) {
...
export const sendMail = createAsyncThunk(
  ...
  async (params, thunkAPI) => {
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_API_URL}/api/sendmail`,
        params,
        {
          headers: {
